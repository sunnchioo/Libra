...
namespace TFHEpp {
    ...
    lweKey::lweKey() {
        ...
        generate_hamming_secret_key<lvl1Lparam>(lvl1L, 512);

        // generate_hamming_secret_key<lvl0param>(lvl0, 256);
        // generate_hamming_secret_key<lvl1param>(lvl1, 256);
        // generate_hamming_secret_key<lvl2param>(lvl2, 512);
        // generate_hamming_secret_key<lvl1Lparam>(lvl1L, 256);
    ...
    Key<P> lweKey::get() const {
        if constexpr (std::is_same_v<P, lvl0param>)
            ...
            return lvl2;
        else if constexpr (std::is_same_v<P, lvl1Lparam>)
            return lvl1L;
    }
