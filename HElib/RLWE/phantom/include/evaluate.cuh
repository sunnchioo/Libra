...
inline auto rotate_vector(const PhantomContext &context, const PhantomCiphertext &encrypted, int step,
                          const PhantomGaloisKey &galois_key,
                          const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    // std::cout << " before destination = encrypted " << std::endl;
    PhantomCiphertext destination;
    destination = encrypted;
    // std::cout << " destination = encrypted " << std::endl;
...
/********************** New kernel *************************/
void right_shift_inplace(const PhantomContext &context, PhantomCiphertext &encrypted, int shift = 1,
                         const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream);

inline auto right_shift(const PhantomContext &context, PhantomCiphertext &encrypted, int shift = 1,
                        const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    right_shift_inplace(context, destination, shift, stream_wrapper);
    return destination;
}
...
inline auto multiply_const(const PhantomContext &context, const PhantomCiphertext &encrypted, const double constant,
                           const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    multiply_const_inplace(context, destination, constant, stream_wrapper);
    return destination;
}
...
inline auto add_const(const PhantomContext &context, const PhantomCiphertext &encrypted, const double constant,
                      const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    add_const_inplace(context, destination, constant, stream_wrapper);
    return destination;
}
...
inline auto format_switch_modrasing(const PhantomContext &context, const PhantomCiphertext &encrypted,
                                    const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    format_switch_modrasing_inplace(context, destination, stream_wrapper);
    return destination;
}
...
inline auto format_switch_modrasing_new(const PhantomContext &context, const PhantomCiphertext &encrypted,
                                        const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    format_switch_modrasing_inplace_new(context, destination, stream_wrapper);
    return destination;
}
...
inline auto mult_image_unit(const PhantomContext &context, const PhantomCiphertext &encrypted,
                            const phantom::util::cuda_stream_wrapper &stream_wrapper = *phantom::util::global_variables::default_stream) {
    PhantomCiphertext destination = encrypted;
    mult_image_unit_inplace(context, destination, stream_wrapper);
    return destination;
}
/********************** New kernel *************************/
