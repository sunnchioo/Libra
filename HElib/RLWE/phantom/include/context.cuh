...
public:
    ...
    */
     ...
     * Creates an instance of Context.
     @param[in] params
     @param[out] pointer of PhantomContext
     */
    [[nodiscard]] auto Create(const phantom::EncryptionParameters &params) {
        return std::shared_ptr<PhantomContext>(new PhantomContext(params));
    }
