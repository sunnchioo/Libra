...
__global__ void right_shift_rns_poly(const uint64_t *operand,
                                     ...
                                     const uint64_t coeff_mod_size, int shift_bits = 1);

__global__ void dot_product_mod_and_add(const uint64_t *operand0, const uint64_t *operand1, const DModulus *modulus,
