...
namespace phantom::arith {
    ...
    public:
        ...
        void init(const RNSBase &cpu_rns_base, bool isLWE, const cudaStream_t &stream);
        ...
        void decompose_double(uint64_t *dst, const double value, const uint32_t poly_degree,
