...
namespace phantom {
    DRNSTool::DRNSTool(size_t n, size_t size_P, const RNSBase &base, const std::vector<Modulus> &modulus_QP, const Modulus &t, const cudaStream_t &stream) {
    ...
    DRNSTool::DRNSTool(size_t n, size_t size_P, const RNSBase &base, const std::vector<Modulus> &modulus_QP,
        ...
        if (size_P != 0) {
            ...
            if (base_size <= size_Q) {
                ...
                // std::cout << "size_Ql: " << size_Ql << " beta: " << beta << " alpha: " << alpha << std::endl;
