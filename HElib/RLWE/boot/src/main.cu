...
int main() {
    ...
    */
    if (TEST_TARGET == "GELU") {
        ...
        ifstream input_file("/home/syt/data/fhec/data/input/gelu_input_32768.txt");
        while (input_file >> num) {
            input.push_back(num);
        }
        input_file.close();

        ifstream calibration_file("/home/syt/data/fhec/data/calibration/gelu_calibration_32768.txt");
        while (calibration_file >> num) {
