...
int main() {
    ...
    /***** head end *****/
    // TODO: unhandled op: llvm.mlir.global
    // TODO: unhandled op: llvm.func
    ckks_evaluator.evaluator.add(SIMDCipher0, SIMDCipher1, SIMDCipher2);
    // store result
    SIMDCipher3 = SIMDCipher2;
    ckks_evaluator.evaluator.multiply(SIMDCipher4, SIMDCipher5, SIMDCipher6);
    // store result
    SIMDCipher7 = SIMDCipher6;
