module {
  ...
  func.func @main() -> i32 {
    ...
    %8 = affine.for %arg0 = 0 to 8 iter_args(%arg1 = %cst) -> (f64) {
      ...
      %14 = arith.select %13, %12, %arg1 : f64
      affine.yield %14 : f64
    }
    %9 = llvm.mlir.addressof @str1 : !llvm.ptr
    %10 = llvm.getelementptr %9[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<9 x i8>
    %11 = llvm.call @printf(%10, %8) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, f64) -> i32
    return %c0_i32 : i32
  }
}
