...
int main() {
  ...
  Pointer<cuTLWE<lwe_enc_lvl>> v20(10);
  FlyHE_SISDEncrypt(hectx, v20, v5, 10);
  Pointer<cuTLWE<lwe_enc_lvl>> v21(10);
  FlyHE_SISDEncrypt(hectx, v21, v6, 10);
  Pointer<cuTLWE<lwe_enc_lvl>> v22(10);
  FlyHE_SISDAdd(hectx, v22, v20, v21, 10);
  std::vector<double> v23(10);
  FlyHE_SISDDecrypt(hectx, v23, v22, 10);
